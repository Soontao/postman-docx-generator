...
#
#     result = postman_object_from_dict(json.loads(json_string))
...
class PurpleAuth:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'PurpleAuth':
        assert isinstance(obj, dict)
        key = from_str(obj.get("key"))
        type = from_union([from_str, from_none], obj.get("type"))
        value = obj.get("value")
        return PurpleAuth(key, type, value)
...
class Auth:
    ...
    """
    awsv4: Optional[List[PurpleAuth]]
    """The attributes for [Basic
    Authentication](https://en.wikipedia.org/wiki/Basic_access_authentication).
    """
    basic: Optional[List[PurpleAuth]]
    """The helper attributes for [Bearer Token
    Authentication](https://tools.ietf.org/html/rfc6750)
    """
    bearer: Optional[List[PurpleAuth]]
    """The attributes for [Digest
    Authentication](https://en.wikipedia.org/wiki/Digest_access_authentication).
    """
    digest: Optional[List[PurpleAuth]]
    """The attributes for [Hawk Authentication](https://github.com/hueniverse/hawk)"""
    hawk: Optional[List[PurpleAuth]]
    noauth: Any
    """The attributes for [NTLM
    Authentication](https://msdn.microsoft.com/en-us/library/cc237488.aspx)
    """
    ntlm: Optional[List[PurpleAuth]]
    """The attributes for [OAuth2](https://oauth.net/1/)"""
    oauth1: Optional[List[PurpleAuth]]
    """Helper attributes for [OAuth2](https://oauth.net/2/)"""
    oauth2: Optional[List[PurpleAuth]]
    type: AuthType

    def __init__(self, awsv4: Optional[List[PurpleAuth]], basic: Optional[List[PurpleAuth]], bearer: Optional[List[PurpleAuth]], digest: Optional[List[PurpleAuth]], hawk: Optional[List[PurpleAuth]], noauth: Any, ntlm: Optional[List[PurpleAuth]], oauth1: Optional[List[PurpleAuth]], oauth2: Optional[List[PurpleAuth]], type: AuthType) -> None:
        self.awsv4 = awsv4
        self.basic = basic
        self.bearer = bearer
        self.digest = digest
    ...
    def from_dict(obj: Any) -> 'Auth':
        assert isinstance(obj, dict)
        awsv4 = from_union([lambda x: from_list(PurpleAuth.from_dict, x), from_none], obj.get("awsv4"))
        basic = from_union([lambda x: from_list(PurpleAuth.from_dict, x), from_none], obj.get("basic"))
        bearer = from_union([lambda x: from_list(PurpleAuth.from_dict, x), from_none], obj.get("bearer"))
        digest = from_union([lambda x: from_list(PurpleAuth.from_dict, x), from_none], obj.get("digest"))
        hawk = from_union([lambda x: from_list(PurpleAuth.from_dict, x), from_none], obj.get("hawk"))
        noauth = obj.get("noauth")
        ntlm = from_union([lambda x: from_list(PurpleAuth.from_dict, x), from_none], obj.get("ntlm"))
        oauth1 = from_union([lambda x: from_list(PurpleAuth.from_dict, x), from_none], obj.get("oauth1"))
        oauth2 = from_union([lambda x: from_list(PurpleAuth.from_dict, x), from_none], obj.get("oauth2"))
        type = AuthType(obj.get("type"))
        return Auth(awsv4, basic, bearer, digest, hawk, noauth, ntlm, oauth1, oauth2, type)

    def to_dict(self) -> dict:
        result: dict = {}
        result["awsv4"] = from_union([lambda x: from_list(lambda x: to_class(PurpleAuth, x), x), from_none], self.awsv4)
        result["basic"] = from_union([lambda x: from_list(lambda x: to_class(PurpleAuth, x), x), from_none], self.basic)
        result["bearer"] = from_union([lambda x: from_list(lambda x: to_class(PurpleAuth, x), x), from_none], self.bearer)
        result["digest"] = from_union([lambda x: from_list(lambda x: to_class(PurpleAuth, x), x), from_none], self.digest)
        result["hawk"] = from_union([lambda x: from_list(lambda x: to_class(PurpleAuth, x), x), from_none], self.hawk)
        result["noauth"] = self.noauth
        result["ntlm"] = from_union([lambda x: from_list(lambda x: to_class(PurpleAuth, x), x), from_none], self.ntlm)
        result["oauth1"] = from_union([lambda x: from_list(lambda x: to_class(PurpleAuth, x), x), from_none], self.oauth1)
        result["oauth2"] = from_union([lambda x: from_list(lambda x: to_class(PurpleAuth, x), x), from_none], self.oauth2)
...
class QueryParam:
    ...
    def __init__(self, description: Union[Description, None, str], disabled: Optional[bool], key: Optional[str], value: Optional[str]) -> None:
...
class Variable:
    ...
    *Note: Collection variables must not contain any sensitive information.*
    ...
    def __init__(self, description: Union[Description, None, str], disabled: Optional[bool], id: Optional[str], key: Optional[str], name: Optional[str], system: Optional[bool], type: Optional[VariableType], value: Any) -> None:
        self.description = description
        self.disabled = disabled
        self.id = id
        self.key = key
...
class URLClass:
    ...
    def __init__(self, hash: Optional[str], host: Union[List[str], None, str], path: Union[List[Union[PathClass, str]], None, str], port: Optional[str], protocol: Optional[str], query: Optional[List[QueryParam]], raw: Optional[str], variable: Optional[List[Variable]]) -> None:
        self.hash = hash
        self.host = host
        self.path = path
        self.port = port
    ...
    def from_dict(obj: Any) -> 'URLClass':
        ...
        path = from_union([lambda x: from_list(lambda x: from_union([PathClass.from_dict, from_str], x), x), from_str, from_none], obj.get("path"))
    ...
    def to_dict(self) -> dict:
        ...
        result["path"] = from_union([lambda x: from_list(lambda x: from_union([lambda x: to_class(PathClass, x), from_str], x), x), from_str, from_none], self.path)
        ...
        result["variable"] = from_union([lambda x: from_list(lambda x: to_class(Variable, x), x), from_none], self.variable)
        return result
...
class Script:
    ...
    def __init__(self, exec: Union[List[str], None, str], id: Optional[str], name: Optional[str], src: Union[URLClass, None, str], type: Optional[str]) -> None:
        self.exec = exec
        self.id = id
        self.name = name
        self.src = src
...
class Information:
    ...
    *Note: This field exists for compatibility reasons with Collection Format V1.*
    ...
    def __init__(self, postman_id: Optional[str], description: Union[Description, None, str], name: str, schema: str, version: Union[CollectionVersionClass, None, str]) -> None:
    ...
    def to_dict(self) -> dict:
        ...
        result["version"] = from_union([lambda x: to_class(CollectionVersionClass, x), from_str, from_none], self.version)
        return result
...
class FormParameter:
    ...
    def __init__(self, content_type: Optional[str], description: Union[Description, None, str], disabled: Optional[bool], key: str, type: Optional[FormParameterType], value: Optional[str], src: Optional[str]) -> None:
...
class URLEncodedParameter:
    ...
    def __init__(self, description: Union[Description, None, str], disabled: Optional[bool], key: str, value: Optional[str]) -> None:
        self.description = description
        self.disabled = disabled
        self.key = key
        self.value = value
...
class Body:
    ...
    def __init__(self, file: Optional[File], formdata: Optional[List[FormParameter]], mode: Optional[Mode], raw: Optional[str], urlencoded: Optional[List[URLEncodedParameter]]) -> None:
        self.file = file
    ...
    def from_dict(obj: Any) -> 'Body':
        ...
        raw = from_union([from_str, from_none], obj.get("raw"))
        urlencoded = from_union([lambda x: from_list(URLEncodedParameter.from_dict, x), from_none], obj.get("urlencoded"))
        return Body(file, formdata, mode, raw, urlencoded)

    def to_dict(self) -> dict:
        result: dict = {}
        result["file"] = from_union([lambda x: to_class(File, x), from_none], self.file)
        result["formdata"] = from_union([lambda x: from_list(lambda x: to_class(FormParameter, x), x), from_none], self.formdata)
        result["mode"] = from_union([lambda x: to_enum(Mode, x), from_none], self.mode)
        result["raw"] = from_union([from_str, from_none], self.raw)
        result["urlencoded"] = from_union([lambda x: from_list(lambda x: to_class(URLEncodedParameter, x), x), from_none], self.urlencoded)
        return result
...
class Certificate:
    ...
    def __init__(self, cert: Optional[CERT], key: Optional[Key], matches: Optional[List[Any]], name: Optional[str], passphrase: Optional[str]) -> None:
        self.cert = cert
        self.key = key
...
class Header:
    ...
    def __init__(self, description: Union[Description, None, str], disabled: Optional[bool], key: str, value: str) -> None:
        self.description = description
        self.disabled = disabled
        self.key = key
        self.value = value
...
class ProxyConfig:
    ...
    def __init__(self, disabled: Optional[bool], host: Optional[str], match: Optional[str], port: Optional[int], tunnel: Optional[bool]) -> None:
        self.disabled = disabled
        self.host = host
        self.match = match
        self.port = port
...
class RequestClass:
    ...
    def __init__(self, auth: Optional[Auth], body: Optional[Body], certificate: Optional[Certificate], description: Union[Description, None, str], header: Union[List[Header], None, str], method: Optional[str], proxy: Optional[ProxyConfig], url: Union[URLClass, None, str]) -> None:
        self.auth = auth
        self.body = body
    ...
    def to_dict(self) -> dict:
        ...
        result["description"] = from_union([lambda x: to_class(Description, x), from_none, from_str], self.description)
        result["header"] = from_union([lambda x: from_list(lambda x: to_class(Header, x), x), from_str, from_none], self.header)
...
class Cookie:
    ...
    def __init__(self, domain: str, expires: Union[float, None, str], extensions: Optional[List[Any]], host_only: Optional[bool], http_only: Optional[bool], max_age: Optional[str], name: Optional[str], path: str, secure: Optional[bool], session: Optional[bool], value: Optional[str]) -> None:
        self.domain = domain
...
class ResponseClass:
    ...
    def __init__(self, body: Optional[str], code: Optional[int], cookie: Optional[List[Cookie]], header: Union[List[Union[Header, str]], None, str], id: Optional[str], original_request: Union[RequestClass, None, str], response_time: Union[float, None, str], status: Optional[str]) -> None:
        self.body = body
        self.code = code
        self.cookie = cookie
        self.header = header
    ...
    def from_dict(obj: Any) -> 'ResponseClass':
        ...
        header = from_union([lambda x: from_list(lambda x: from_union([Header.from_dict, from_str], x), x), from_none, from_str], obj.get("header"))
        id = from_union([from_str, from_none], obj.get("id"))
        ...
        return ResponseClass(body, code, cookie, header, id, original_request, response_time, status)
    ...
    def to_dict(self) -> dict:
        ...
        result["header"] = from_union([lambda x: from_list(lambda x: from_union([lambda x: to_class(Header, x), from_str], x), x), from_none, from_str], self.header)
        result["id"] = from_union([from_str, from_none], self.id)
        result["originalRequest"] = from_union([lambda x: to_class(RequestClass, x), from_str, from_none], self.original_request)
...
class Items:
    ...
    def __init__(self, description: Union[Description, None, str], event: Optional[List[Event]], id: Optional[str], name: Optional[str], request: Union[RequestClass, None, str], response: Optional[List[Union[List[Any], bool, ResponseClass, float, int, None, str]]], variable: Optional[List[Variable]], auth: Optional[Auth], item: Optional[List['Items']]) -> None:
        self.description = description
        self.event = event
        self.id = id
        self.name = name
    ...
    def from_dict(obj: Any) -> 'Items':
        ...
        response = from_union([lambda x: from_list(lambda x: from_union([from_none, from_float, from_int, from_bool, from_str, lambda x: from_list(lambda x: x, x), ResponseClass.from_dict], x), x), from_none], obj.get("response"))
        variable = from_union([lambda x: from_list(Variable.from_dict, x), from_none], obj.get("variable"))
        auth = from_union([from_none, Auth.from_dict], obj.get("auth"))
        item = from_union([lambda x: from_list(Items.from_dict, x), from_none], obj.get("item"))
        return Items(description, event, id, name, request, response, variable, auth, item)
    ...
    def to_dict(self) -> dict:
        ...
        result["response"] = from_union([lambda x: from_list(lambda x: from_union([from_none, to_float, from_int, from_bool, from_str, lambda x: from_list(lambda x: x, x), lambda x: to_class(ResponseClass, x)], x), x), from_none], self.response)
        result["variable"] = from_union([lambda x: from_list(lambda x: to_class(Variable, x), x), from_none], self.variable)
        result["auth"] = from_union([from_none, lambda x: to_class(Auth, x)], self.auth)
...
class PostmanObject:
    ...
    def __init__(self, auth: Optional[Auth], event: Optional[List[Event]], info: Information, item: List[Items], variable: Optional[List[Variable]]) -> None:
        self.auth = auth
        self.event = event
        self.info = info
        self.item = item
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'PostmanObject':
        assert isinstance(obj, dict)
        auth = from_union([from_none, Auth.from_dict], obj.get("auth"))
        event = from_union([lambda x: from_list(Event.from_dict, x), from_none], obj.get("event"))
        ...
        variable = from_union([lambda x: from_list(Variable.from_dict, x), from_none], obj.get("variable"))
        return PostmanObject(auth, event, info, item, variable)
...
def postman_object_from_dict(s: Any) -> PostmanObject:
    return PostmanObject.from_dict(s)


def postman_object_to_dict(x: PostmanObject) -> Any:
    return to_class(PostmanObject, x)
